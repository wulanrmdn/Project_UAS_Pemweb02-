					...
					<div class="col-xl-12">
						<div class="card students-list">
							<div class="card-header border-0 flex-wrap pb-0">
								...
								<a href="/lecturer/create" class="btn btn-primary"><i class="fas fa-plus"></i> Add Lecturer</a>
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													...
													<div class="d-flex">
														<a href="/lecturer/edit/{{  $item['id']  }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-pencil"></i></a>
                                                        <form action="/lecturer" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('delete')
